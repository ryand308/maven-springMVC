...
@Repository
public class EmployeeDaoTemplate implements BasicDao<Employee, Long> , BasicExtraDao<Employee, Long>{
	...
	public Employee findById(Long id) {
		...
		Employee emp = null;
		try {
			 emp = jdbcTemplate.queryForObject(EmployeeSql.GENERIC_FINDBYID, new BeanPropertyRowMapper<>(Employee.class), id);
